    ...
    <div class="container">
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-2">
                <ul class="nav navbar-nav">
                    <li class="hvr-bounce-to-bottom active"><a href="<?php echo U('admin/gallery');?>"><font face="微软雅黑">文章列表<span class="sr-only">(current)</span></font></a></li>
                    <li class="hvr-bounce-to-bottom"><a href="<?php echo U('admin/gallery_add');?>"><font face="微软雅黑">文章添加</font></a></li>
                </ul>
                <div class="clearfix"></div>
            </div><!-- /.navbar-collapse -->
        </nav>
...
<?php if(is_array($info)): foreach($info as $key=>$vo): ?><div class="container">
        <br>
    <li><a href="<?php echo U('admin/gallery_show',array('id'=>$vo['id']));?>"><font face="微软雅黑"><?php echo ($vo["name"]); ?></font></a></li>
    <?php echo ($vo["create_time"]); ?><br>
    <?php echo ($vo["abstract"]); ?><br>
    <li><a href="<?php echo U('admin/gallery_show',array('id'=>$vo['id']));?>"><font face="微软雅黑">查看全文</font></a></li>
    <li><a href="<?php echo U('admin/gallery_edit',array('id'=>$vo['id']));?>"><font face="微软雅黑">编辑</font></a></li>
    <li><a href="<?php echo U('admin/gallery_delete',array('id'=>$vo['id']));?>"><font face="微软雅黑">删除</font></a></li>
