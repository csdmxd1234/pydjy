        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-2">
                <ul class="nav navbar-nav">
                    ...
                    <li class="hvr-bounce-to-bottom active"><a href="<?php echo U('admin/gallery_add');?>"><font face="微软雅黑">文章添加</font></a></li>
                </ul>
                <div class="clearfix"></div>
            </div><!-- /.navbar-collapse -->
        </nav>
...
<div class="contact">
    <div class="container">
        <div class="contact-form">
            <center>
            <form method="post" action="<?php echo U('admin/gallery_add_post');?>">
                标题<br>
