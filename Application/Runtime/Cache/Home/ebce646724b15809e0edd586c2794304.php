...
<!-- VR简述 -->
<!-- VR简述-page -->
<?php if(is_array($info)): foreach($info as $key=>$vo): ?><div class="about-page">
    <div class="container">
        <div class="about-grids">
            <div class="col-md-7 about-grid">
                <p><font size=4> <font family:"微软雅黑";font-weight:bold>姓名：<?php echo ($vo["name"]); ?></font></p>
                <p><font size=4> <font family:"微软雅黑";font-weight:bold>E-mail：<?php echo ($vo["email"]); ?></font></p>
                <p><font size=4> <font family:"微软雅黑";font-weight:bold></font>电话：<?php echo ($vo["telephone"]); ?></p>
                <p><font size=4><font family:"微软雅黑";font-weight:bold></font>留言：<?php echo ($vo["message"]); ?></p>
                <li><a href="<?php echo U('admin/contact_delete',array('id'=>$vo['id']));?>"><font face="微软雅黑">删除</font></a></li>
            </div>
