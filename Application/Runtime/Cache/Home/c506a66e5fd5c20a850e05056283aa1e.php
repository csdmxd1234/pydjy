        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="hvr-bounce-to-bottom active"><a href="<?php echo U('admin/index');?>"><font face="微软雅黑">后台主页<span class="sr-only">(current)</span></font></a></li>
                    <li class="hvr-bounce-to-bottom"><a href="<?php echo U('admin/gallery');?>"><font face="微软雅黑">文章管理</font></a></li>
